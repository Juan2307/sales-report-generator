 ...
 * - Archivo de vendedores (vendedores.txt)
 * - Archivos de ventas individuales por vendedor (ventas_X.txt)
 * 
 * Los archivos se almacenan en la carpeta "data/" dentro del proyecto.
 * 
 * Estos archivos serán utilizados como entrada para la segunda parte del proyecto.
 * 
...
public class GenerateInfoFiles {
    ...
    public static void createProductsFile(int productsCount) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(
                new FileWriter(OUTPUT_FOLDER + "productos.txt"))) {
    ...
    public static void createSalesManInfoFile(int salesmanCount) throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(
                new FileWriter(OUTPUT_FOLDER + "vendedores.txt"))) {

            String[] nombres = {
                "JUAN ANDRES", "DUVANT", "MARIA SUSANA",
                "CHRISTIAN DAVID", "DIEGO"
            };

            String[] apellidos = {
                "LEANDRO RODRIGUEZ", "FANDIÑO REYES",
                "OSPINA VANEGAS", "SANDOVAL PERALTA", "ROA"
            };
